        ...
        @foreach($produtos as $teste)
            <tr>
                ...
                <td style="width: 1000px; height: 200px;">
                    <img src="{{ asset("/storage/app/{$teste->fotop}")}}" alt="Descrição da Imagem" class="w-60 h-38 rounded-lg shadow-md" id="fotop"></td>
                <td >{{$teste->descricao}}</td>
                <td >{{$teste->categoria_id}}</td>
                <td>
                <a href="{{route('produto.edit',$teste->id)}}">Editar</a>
